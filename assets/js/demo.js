...
function updateCSS(css){
   ...
   $("head").append('<link rel="stylesheet" type="text/css" href="assets/css/' + css +'.css"/*tpa=http://www.marcellop.com/bootmetro/assets/js/assets/css/' + css +'.css*/>');
      ...
      $('.download-btn').on('click', function () {
         ...
         var css = $("#components.download input:checked")
            ...
            , js = $("#plugins.download input:checked")
               ...
               .toArray()
            , vars = {}
            , img = ['glyphicons-halflings.png'/*tpa=http://www.marcellop.com/bootmetro/assets/js/glyphicons-halflings.png*/, 'glyphicons-halflings-white.png'/*tpa=http://www.marcellop.com/bootmetro/assets/js/glyphicons-halflings-white.png*/]
         ...
         $.ajax({
            type: 'POST'
            , url: /\?dev/.test(window.location) ? '../../../../localhost/index-1.htm'/*tpa=http://localhost:3000/*/ : '../../../../bootstrap.herokuapp.com/index.htm'/*tpa=http://bootstrap.herokuapp.com/*/
            , dataType: 'jsonpi'
            , params: {
               js: js
               , css: css
